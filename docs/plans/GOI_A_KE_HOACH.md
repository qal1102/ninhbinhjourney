...
- Production deployment `dpl_EfHq65vZgcJs89jd5sqYbhX6SVpF` đang giữ alias `https://ninhbinhjourney.vercel.app`; health trả HTTP 200 với `experienceMode=production`. A6 director smoke read-only đạt **2/2** desktop/mobile với expectation `canary-ready`.
