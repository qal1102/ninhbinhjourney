...
const copy = {
  ...
  vi: {
    ...
    title: "Ninh Bình",
    subtitle: "Núi đá vôi, sông nước và cố đô Hoa Lư",
    footerNote: "Ninh Bình Journey · Núi đá vôi, sông nước và cố đô Hoa Lư.",
    ...
    storiesIntro:
      "Ba bài viết ngắn để bạn hình dung trước khi đi.",
    signatureStories: "Tuyến nổi bật",
    hiddenGems: "Những góc lặng của Ninh Bình",
    hiddenGemsIntro:
      "Đầm Vân Long, động Am Tiên, chùa Bích Động, đền Thái Vi. Mấy nơi này vắng hơn, vì khách đi Ninh Bình hai ngày thường không kịp ghé.",
    seeAllDestinations: "Xem tất cả điểm đến",
    featuredLabel: "Điểm đến nổi bật",
    featuredTitle: "Sáu nơi nên đi trước",
    featuredIntro:
      "Đây là sáu nơi khách về hay nhắc tới nhất, từ chuyến thuyền Tràng An tới 486 bậc đá Hang Múa. Muốn xem đủ mười lăm nơi thì danh sách nằm ngay bên dưới.",
    ...
    indexIntro:
      "Hang Múa và Cố đô Hoa Lư đông khách quanh năm. Đầm Vân Long, động Am Tiên thì hay bị bỏ đầu tiên khi lịch trình ngắn, nên tới giờ vẫn vắng.",
    indexHint: "Rê chuột qua từng tên để xem ảnh và thời gian nên dành cho nơi đó.",
    indexOpen: "Mở điểm đến",
    zigzagLabel: "Toàn bộ điểm đến",
    zigzagTitle: "Đủ mười lăm điểm đến",
    zigzagIntro:
      "Có nơi phải leo, như 486 bậc đá ở Hang Múa. Có nơi ngồi thuyền hai tiếng qua ba hang, như Tam Cốc. Còn ở Vân Long, bạn chỉ cần ngồi yên trên thuyền, may ra thấy đàn voọc trên vách núi.",
    zigzagCtaTitle: "Chưa biết nên bắt đầu từ đâu?",
    zigzagCtaBody:
      "Mười lăm nơi mà thời gian thì có hạn. Bạn cho chúng tôi biết mình có mấy ngày, đi với ai, muốn đi nhanh hay thong thả, chúng tôi sắp lịch giúp.",
    ...
    experienceName: "Di sản ban ngày, Phố cổ buổi tối",
    ...
    viewExperience: "Xem chi tiết",
    reserve: "Giữ chỗ",
    checkoutTitle: "Thông tin giữ chỗ",
    checkoutIntro: "Xem lại lịch trình và cách thanh toán. Đây là bản thử, không trừ tiền thật.",
    guests: "Số khách",
    transport: "Xe riêng",
    ...
    locationOutside: "Bạn đang ở ngoài Ninh Bình nên bản đồ quay về Tràng An.",
    locationDenied: "Bạn chưa cho phép xem vị trí.",
  },
...
> = {
  ...
  vi: {
    ...
    progressLabel: "Chuyến thuyền đi thế nào",
    beats: [
      {
        id: "den-trinh",
        image: "/images/destinations/intro-trang-an-rain.png",
        ...
        body: "Thuyền rời Đền Trình, đi một vòng mất khoảng 3–4 giờ. Tuyến 1 qua chín hang, nhiều nhất trong các tuyến ở Tràng An, hợp với ai muốn ngồi thuyền cả buổi.",
      },
      {
        id: "hang-toi",
        image: "/images/destinations/intro-trang-an-rain.png",
        ...
        body: "Sau Hang Địa Linh, thuyền vào hang dài nhất tuyến. Suốt 320 mét, trước mắt chỉ còn mặt nước và vòm đá sát trên đầu.",
      },
      {
        id: "den-tran",
        image: "/images/destinations/trang-an.jpg",
      ...
      },
      {
        ...
        body: "Qua Hang Ba Giọt, Hang Seo và Hang Sơn Dương, thuyền ghé Phủ Khống rồi Chùa Báo Hiếu. Tới mỗi đền, khách có thể lên bờ vãn cảnh, thắp hương.",
      },
      {
        id: "quy-hau",
        image: "/images/destinations/intro-trang-an-rain.png",
        ...
        body: "Qua Hang Khống và Hang Trần là thuyền về lại bến, vừa đủ chín hang.",
      },
    ],
  },
};
...
const routeCollections = [
  {
    ...
    title: {
      ...
      vi: "Hai tuyến thuyền: chín hang Tràng An, ba hang Tam Cốc",
    },
    body: {
  ...
  },
  {
    ...
    body: {
      ...
      vi: "Lên Hang Múa là 486 bậc đá dọc sườn Ngọa Long, tới đỉnh thì cả thung lũng Tam Cốc nằm dưới chân. Động Am Tiên thì ngược lại, phải đi xuống hơn hai trăm bậc vào một thung kín, nơi Thái hậu Dương Vân Nga về tu những năm cuối đời, cũng là nơi Đinh Tiên Hoàng từng nuôi hổ báo để trị tội. Xong hai nơi ấy, ghé Phố cổ Hoa Lư là vừa lúc lên đèn.",
    },
