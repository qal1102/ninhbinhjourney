...
**Nghiên cứu thiết kế 03/08 — 4 trang awwwards mới, xem chi tiết ở `docs/reference/REFERENCE_SITE_ANALYSIS.md`.** Bốn việc còn chưa làm, đáng ưu tiên theo thứ tự: (1) timeline lịch sử tương tác cho Tràng An/Hoa Lư/Bái Đính thay vì đoạn văn phẳng, (2) nâng khối trích dẫn `press` thành pull-quote to thay vì chú thích nhỏ, (3) chọn một câu triết lý neo dùng lại xuyên suốt (hero/meta/footer) thay vì mỗi chỗ một câu khác, (4) khung khan hiếm trung thực dựa trên giới hạn thật (số thuyền/ngày ở Tràng An, mùa chim ở Vân Long) — không bịa số.
