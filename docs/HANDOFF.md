...
>
> Cập nhật: **07/08/2026** — sau đợt làm T1–T10, W3, buổi chốt thiết kế danh tính/hồ sơ/nhật ký và đợt sửa định danh ảnh/video + tuyến public web đang ở local, chưa deploy (mục 2.6).
>
...
> **Trạng thái public web mới nhất 07/08:** batch sửa sai địa danh trong 3 cinematic panel, dựng lại thẻ tuyến theo từng chặng và thay tương tác “Mười nơi nữa” **đã xong + build/test production cục bộ, nhưng CHƯA commit/push/deploy**. Production vẫn là batch show-off commit app `f5c3925`, deployment `dpl_9ifDJSFhCoXSiCJmi5SbkrAfFkEb`. Không được nhìn phần mô tả “đã xong” ở mục 2.6 rồi suy ra nó đã có trên URL production.
...
**07/08 (W5, đã xong ở local, CHƯA deploy) — sửa lỗi định danh media do chủ dự án bắt bằng mắt và thay hai tương tác đang phô kỹ thuật nhưng kể sai nội dung.** Lỗi gốc không nằm ở codec hay trình phát: batch 06/08 đặt tên file/copy theo câu chuyện muốn kể mà không có bảng ánh xạ nguồn → địa danh. Hậu quả nhìn thấy được: video Tràng An đứng tên Cố đô Hoa Lư; cảnh đỉnh Ngọa Long đứng tên Tuyến 1 Tràng An; một cảnh Tràng An khác đứng tên sông Ngô Đồng/Tam Cốc; ảnh Phố cổ Hoa Lư làm bìa cho tiêu đề Hang Múa–Am Tiên; thẻ tuyến đầu còn nói sai “cả ngày không đặt chân xuống đất” dù tuyến có Thung Nham.
...
| — | **W5** | 🟡 **Sửa định danh media + dựng lại route/index public** | **Code/UI/test đã xong ở local 07/08, chưa commit/push/deploy.** Ba cinematic đã ánh xạ lại bằng tiêu đề nguồn + frame thật; route đổi ảnh theo từng chặng; “Mười nơi nữa” thành split-screen sticky preview. Production build cục bộ sạch, `public-surfaces.spec.ts` 28/28 xanh. Còn đúng một bước có thay đổi trạng thái ngoài máy: chủ dự án xem ảnh/bản local rồi quyết định commit + deploy; xem đầy đủ ở mục 2.6 |
