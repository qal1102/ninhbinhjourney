...
const campaign = {
  vi: {
    ...
    groups: [
      ...
      {
        id: "brand-atelier",
        eyebrow: "Năm đề xuất thương hiệu",
        title: "Năm cuộc đối thoại chưa bắt đầu.",
        body: "Một lookbook mở cho những cuộc gặp giữa thời trang, thủ công, cảnh quan và văn hóa Ninh Bình. Mỗi hình ảnh là một đề xuất sáng tạo độc lập, được đặt ở đây để mở đầu cho một cuộc trò chuyện có chủ đích.",
        ratio: "portrait",
        layout: "atelier",
        items: [
          {
            id: "bottega-veneta-concept",
            kicker: "01 · Chất liệu & thủ công",
            title: "Bottega Veneta · The Green Passage",
            body: "Màu xanh, kỹ nghệ đan và chuyển động chậm gặp nhau trong một hành trình qua miền đá, nước và lúa.",
          ...
          {
            id: "celine-concept",
            kicker: "02 · Tĩnh lặng & đường nét",
            title: "Celine · Quiet Horizons",
            body: "Áo dài, đường nét tối giản và khoảng trời rộng tạo nên một câu chuyện thời trang không cần phô trương.",
          ...
          {
            id: "chanel-concept",
            kicker: "03 · Hoa, tweed & di sản",
            title: "Chanel · Grace in Bloom",
            body: "Một cuộc đối thoại giữa vẻ thanh lịch, sắc hoa mùa hội và chiều sâu của cảnh quan di sản.",
          ...
          {
            id: "hermes-concept",
            kicker: "04 · Da thuộc & hành trình",
            title: "Hermès · Crafted by the River",
            body: "Tinh thần thủ công, sắc cam và nhịp chậm của dòng sông gợi mở một chuyến đi được làm nên bằng thời gian.",
          ...
          {
            id: "prada-concept",
            kicker: "05 · Hiện đại & bình yên",
            title: "Prada · Modern Calm",
            body: "Sự chính xác hiện đại đặt giữa non nước tĩnh tại, tạo nên một tương phản đủ mạnh mà vẫn tự nhiên.",
  ...
  en: {
    ...
    groups: [
      ...
      {
        id: "brand-atelier",
        eyebrow: "Five brand proposals",
        title: "Five conversations yet to begin.",
        body: "An open lookbook for encounters between fashion, craft, landscape and the culture of Ninh Binh. Each image is an independent creative proposal, presented here to begin a purposeful conversation.",
        ratio: "portrait",
        layout: "atelier",
        items: [
          { id: "bottega-veneta-concept", kicker: "01 · Material & craft", title: "Bottega Veneta · The Green Passage", body: "Green, woven craft and unhurried movement meet on a passage through limestone, water and rice fields.", image: "/images/campaigns/mid-autumn-2026/brand-proposals/bottega-veneta-concept.webp", action: "contact", concept: true },
          { id: "celine-concept", kicker: "02 · Quiet & line", title: "Celine · Quiet Horizons", body: "The ao dai, a restrained silhouette and an open horizon form a fashion story without spectacle.", image: "/images/campaigns/mid-autumn-2026/brand-proposals/celine-concept.webp", action: "contact", concept: true },
          { id: "chanel-concept", kicker: "03 · Flowers, tweed & heritage", title: "Chanel · Grace in Bloom", body: "A dialogue between composed elegance, festival flowers and the depth of a heritage landscape.", image: "/images/campaigns/mid-autumn-2026/brand-proposals/chanel-concept.webp", action: "contact", concept: true },
          { id: "hermes-concept", kicker: "04 · Leather & passage", title: "Hermès · Crafted by the River", body: "Craft, orange and the river's slower rhythm suggest a journey shaped carefully over time.", image: "/images/campaigns/mid-autumn-2026/brand-proposals/hermes-concept.webp", action: "contact", concept: true },
          { id: "prada-concept", kicker: "05 · Modernity & calm", title: "Prada · Modern Calm", body: "Modern precision set against a still waterscape creates a contrast that feels both decisive and natural.", image: "/images/campaigns/mid-autumn-2026/brand-proposals/prada-concept.webp", action: "contact", concept: true },
        ],
      },
    ] satisfies SeasonalGroup[],
  },
