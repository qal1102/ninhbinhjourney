...
**06/08 (batch show-off, đang ship) — bỏ hoàn toàn YouTube player khỏi ba khung cinematic và thêm interaction nhìn thấy được.** Chủ dự án chốt đây là bản demo ngắn hạn và yêu cầu tự host ngay. Đã làm:
...
1. Mở vùng click cho toàn bộ route card và card `/explore`, nhưng vẫn giữ semantic link/nút đúng và không làm nested interactive element; đây là cải thiện UX chắc chắn nhất.
